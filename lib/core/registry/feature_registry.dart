...
typedef FeatureScreenBuilder = Widget Function(BuildContext context);
...
abstract final class FeatureRegistry {
  static final employeeModules = <FeatureDefinition>[
    ...
    FeatureDefinition(
      ...
      builder: (_) => const DailyStatusScreen(),
    ),
    FeatureDefinition(
      key: 'enquiry',
      title: 'Enquiry Form',
      ...
      builder: (_) => const EnquiryFormScreen(),
    ),
    FeatureDefinition(
      key: 'appointments',
      title: "Today's Appts",
    ...
    FeatureDefinition(
      ...
      builder: (_) => const AllowancesScreen(),
    ),
    FeatureDefinition(
      key: 'notices',
      title: 'Notices',
