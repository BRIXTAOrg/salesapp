...
class TrackingStore(context: Context) :
    ...
    override fun onUpgrade(
        ...
        if (oldVersion < 2) {
            /*
             * Preserve old v1 rows.
             *
             * We cannot safely guess which employee/day those
             * historical rows belonged to, so the new metadata
             * stays null on old rows.
             */
            ...
            db.execSQL(
                ...
                idx_tracking_points_employee_day
                ON tracking_points(
                    employee_id,
                    work_date,
                    recorded_at
