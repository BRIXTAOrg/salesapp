            ...
            when (call.method) {
                ...
                "start" -> {
                    ...
                    ContextCompat.startForegroundService(
                        ...
                        Intent(
                            this,
                            FieldTrackingService::class.java,
                        ).apply {
                            action =
                                FieldTrackingService.ACTION_START
                ...
                "stop" -> {
                    startService(
                        Intent(
                            ...
                            action =
                                FieldTrackingService.ACTION_STOP
                        },
                    )
                ...
                "locateNow" -> {
                    /*
                     * If the meter is running, ask it for an
                     * immediate fresh position.
                     *
                     * If Android previously killed the service,
                     * restart it from the persisted employee
                     * identity. The service itself will request
                     * the immediate fix.
                     */
                    if (FieldTrackingService.isRunning) {
                        startService(
                            Intent(
                                ...
                                action =
                                    FieldTrackingService.ACTION_LOCATE_NOW
                            },
                        )
                ...
                "status" -> {
                    ...
                    result.success(
                        mapOf(
                             ...
                             * IMPORTANT:
                             *
                             * This is the actual current native
                             * service state.
                             *
                             * Do NOT use PREF_ACTIVE here.
                             */
                            "active" to
                                FieldTrackingService.isRunning,
