...
## Corpus Check
- 87 files · ~46,127 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1322 nodes · 1760 edges · 63 communities (58 shown, 5 thin omitted)
...
- local_kernel_simulator.dart
- runtime_connection_banner.dart
- String?
- firebase_options.dart
- LaunchImage.imageset/README.md
- DynamicCapabilityScreen
- TrackingRepository
- README.md
...
4. `AppSessionController` - 12 edges
...
Cohesion: 0.06
Nodes (32): alert, AppIcons, attendance, _backendIcons, camera, chart, check, chevronRight (+24 more)
...
### Community 23 - "enquiry_form_screen.dart"
Cohesion: 0.07
Nodes (28): core/database/app_database.dart, FormState, build, createState, DailyStatusScreen, _DailyStatusScreenState, _dealersVisited, dispose (+20 more)
...
### Community 27 - "State"
Cohesion: 0.22
Nodes (13): AllowancesScreen, _AllowancesScreenState, _ClaimSheet, _ClaimSheetState, EmployeeDashboardScreen, _EmployeeDashboardScreenState, KernelResponsibilityScreen, _KernelResponsibilityScreenState (+5 more)
...
Cohesion: 0.22
Nodes (8): ../config/tenant_config.dart, build, TenantTheme, build, size, tenant, TenantLogo, package:flutter/material.dart
...
Cohesion: 0.15
Nodes (12): appName, backgroundColor, code, copyWith, demo, displayName, id, logoText (+4 more)
...
Cohesion: 0.11
Nodes (17): bool get, AppDeviceIdentity, appVersion, _cacheKey, _createdAt, _deviceId, initialize, instance (+9 more)
...
### Community 50 - "local_kernel_simulator.dart"
Cohesion: 0.17
Nodes (11): _availablePossibilities, _conditionGroup, _deepMap, initialRuntime, LocalKernelSimulator, _map, _mapList, _resolveValue (+3 more)
...
## Knowledge Gaps
- **833 isolated node(s):** `controller`, `build`, `ApiConfig`, `_compiledDefault`, `_baseUrl` (+828 more)
...
- **Why does `AuthGateway` connect `mock_auth_gateway.dart` to `auth_gateway.dart`, `app_session_controller.dart`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **What connects `controller`, `build`, `ApiConfig` to the rest of the system?**
