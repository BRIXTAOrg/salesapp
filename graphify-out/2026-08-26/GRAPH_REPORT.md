...
2. `AppSessionController` - 24 edges
3. `Win32Window` - 24 edges
4. `TrackingStore` - 16 edges
5. `MobileCapability` - 12 edges
6. `TrackingController` - 12 edges
7. `MessageHandler` - 12 edges
8. `MotionGate` - 11 edges
9. `MainActivity` - 10 edges
...
## Knowledge Gaps
- **1423 isolated node(s):** `controller`, `tracker`, `_readyWork`, `_blockedWork`, `_approvals` (+1418 more)
...
- **Why does `TrackingController` connect `AppSessionController` to `allowances_screen.dart`, `lib/features/dashboard/presentation/employee_dashboard_screen.dart`, `attendance_screen.dart`, `editorial-ui-20260826-013104/lib/features/dashboard/presentation/employee_profile_tab.dart`, `tracking_controller.dart`, `editorial-ui-20260826-013104/lib/features/dashboard/presentation/employee_dashboard_screen.dart`, `tracking_screen.dart`, `kernel_responsibility_screen.dart`, `lib/features/dashboard/presentation/employee_profile_tab.dart`, `cms-sovereignty-20260825-231628/lib/features/dashboard/presentation/employee_dashboard_screen.dart`, `cms-sovereignty-finish-20260825-231953/employee_dashboard_screen.dart`?**
